    ...
    <section className="py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative p-8 rounded-2xl overflow-hidden backdrop-blur-lg border border-gray-800 bg-black"
        >
          ...
          <div className="relative z-10">
            ...
            <div className="font-mono">
              ...
              <motion.a
                href="mailto:ph0ngnguyen@g.ucla.edu
"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <motion.a
                  href="https://github.com/phongtnguyen2006"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">phongtnguyen2006</p>
                  </div>
                </motion.a>
                <motion.a
                  href="https://www.linkedin.com/in/phong-nguyen-53034a2b3/"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.05 }}
                  className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Phong Nguyen</p>
                  </div>
                </motion.a>
              </div>
            </div>
